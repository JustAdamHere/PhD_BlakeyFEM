...
class Solution
{
	protected:
		...
		// Computers.
		virtual double compute_uh(const int &a_i, const double &a_xi, const int &a_n) const;
		virtual double compute_uh(const int &a_i, const double &a_xi, const int &a_n, const std::vector<double> &a_u) const;
